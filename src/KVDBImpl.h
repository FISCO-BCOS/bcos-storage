...
public:
    ...
    bool put(const std::string& _columnFamily, const std::string_view& _key,
        const std::string_view& _value) override;
    std::string get(const std::string& _columnFamily, const std::string_view& _key) override;
    std::shared_ptr<std::vector<std::string> > multiGet(
        const std::string& _columnFamily, std::vector<std::string_view>& _keys) override;
